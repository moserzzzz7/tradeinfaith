...
(async()=>{
 ...
 try {
  ...
  assert.ok(statsText.includes('2W · 1L · 0 BE · 3 trades'),'Win rate card carries the counts');
  ...
  assert.equal(await run('document.querySelector(".kpi-hero .gcard .g-val").style.color'),'var(--muted)','Thin samples are grey');
